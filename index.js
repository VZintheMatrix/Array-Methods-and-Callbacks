...
// items['Year'] and item['Stage'] are calling indexes of the item in your filter function.
...
//     for (item['Home Team Score'] > item['Away Team Score']){
//         return (item['Home Team Name']);

//         else if (item['Home Team Score'] < item['Away Team Score'])
//             return item['Away Team Name'];
        
//         else return 'Game went to penalties';
...
// receive data in my function
// return a new array  (.filter)
// teams from stage['final'] should be included
